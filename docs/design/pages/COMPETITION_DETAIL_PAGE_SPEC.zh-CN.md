...
- [产品全局布局规范](../PRODUCT_GLOBAL_LAYOUT_SPEC.zh-CN.md)
- [产品响应式规范](../PRODUCT_RESPONSIVE_SPEC.zh-CN.md)
- [产品全局交互规范](../PRODUCT_GLOBAL_INTERACTION_SPEC.zh-CN.md)
- [产品全局状态规范](../PRODUCT_GLOBAL_STATE_SPEC.zh-CN.md)
- [产品组件责任规范](../PRODUCT_COMPONENT_RESPONSIBILITY_SPEC.zh-CN.md)
- [产品 Naive UI 映射](../PRODUCT_NAIVE_UI_MAPPING.zh-CN.md)
- [产品共用覆盖层与对话框规范](../PRODUCT_COMMON_OVERLAYS_AND_DIALOGS_SPEC.zh-CN.md)
- [产品实现纠正清单](../PRODUCT_IMPLEMENTATION_CORRECTION_BACKLOG.zh-CN.md)
...
适用[全局交互规范](../PRODUCT_GLOBAL_INTERACTION_SPEC.zh-CN.md)动作合同：页面/赛事/工作区导航使用 `IA-PRODUCT-NAV`，区域重试使用 `IA-RETRY`，URL 与层级恢复使用 `IA-RECOVERY`，窄屏层级/不可用说明使用 `IA-DRAWER-SHEET`，可取消请求使用 `IA-CANCEL`。本节只拥有组别、轮次、对阵选择和类型化交接的页面增量。
...
精确文案、语义和恢复继承[全局状态规范](../PRODUCT_GLOBAL_STATE_SPEC.zh-CN.md)。详情摘要、组别、轮次和对阵是四个状态区域，不能合并为一个 `loading/error`。
