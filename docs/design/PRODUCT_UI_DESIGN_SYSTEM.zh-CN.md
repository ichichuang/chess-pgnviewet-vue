...
1. [产品逐页 UI 设计索引](./PRODUCT_UI_DESIGN_INDEX.zh-CN.md)
2. 本文件
3. [全局布局规范](./PRODUCT_GLOBAL_LAYOUT_SPEC.zh-CN.md)
4. [响应式规范](./PRODUCT_RESPONSIVE_SPEC.zh-CN.md)
5. [全局交互规范](./PRODUCT_GLOBAL_INTERACTION_SPEC.zh-CN.md)
6. [全局状态规范](./PRODUCT_GLOBAL_STATE_SPEC.zh-CN.md)
7. [组件责任规范](./PRODUCT_COMPONENT_RESPONSIBILITY_SPEC.zh-CN.md)
8. [Naive UI 映射](./PRODUCT_NAIVE_UI_MAPPING.zh-CN.md)
9. [共用覆盖层与对话框](./PRODUCT_COMMON_OVERLAYS_AND_DIALOGS_SPEC.zh-CN.md)
10. [实施纠正清单](./PRODUCT_IMPLEMENTATION_CORRECTION_BACKLOG.zh-CN.md)
11. 目标[页面族规范](./pages/UNIFIED_WORKSPACE_PAGE_SPEC.zh-CN.md)

上游权威为[产品设计蓝图](../product/PRODUCT_DESIGN_BLUEPRINT.zh-CN.md)、[主题规范](../ui/THEME_SYSTEM_SPEC.md)、[页面样式规范](../ui/PAGE_STYLE_SPEC.md)、[无障碍规范](../ui/ACCESSIBILITY_SPEC.md)和[语义 Token 权威](../architecture/SEMANTIC_TOKEN_REGISTRY_BASELINE.md)。
...
- 新视觉需求没有现有 Token 时，先登记[实施纠正清单](./PRODUCT_IMPLEMENTATION_CORRECTION_BACKLOG.zh-CN.md)，不得在本文件发明名称。
...
- 组合筛选在窄屏进入受控 sheet，应用后返回触发器；详见[响应式规范](./PRODUCT_RESPONSIVE_SPEC.zh-CN.md)。
...
抽屉、sheet、dialog、popover 的行为由[共用覆盖层与对话框](./PRODUCT_COMMON_OVERLAYS_AND_DIALOGS_SPEC.zh-CN.md)和[全局交互规范](./PRODUCT_GLOBAL_INTERACTION_SPEC.zh-CN.md)拥有。
...
更详细的转换和文案唯一由[全局状态规范](./PRODUCT_GLOBAL_STATE_SPEC.zh-CN.md)拥有。
...
本节是 CURRENT_IMPLEMENTED 事实，不在本文件发明修复名；修复所有权见[实施纠正清单](./PRODUCT_IMPLEMENTATION_CORRECTION_BACKLOG.zh-CN.md)。
