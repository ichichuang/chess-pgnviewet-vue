> **非权威性阅读镜像提示**
> 本文档是原始文件 `docs/design/PRODUCT_UI_IMPLEMENTATION_HANDOFF.zh-CN.md` 的中文阅读镜像，仅供人工浏览。产品、设计、架构与实现权威仍保留在原始源路径，请勿将本镜像作为实施或自动化编辑的依据。
...
- [Naive UI 映射](Naive%20UI映射.md)：基础控件候选与项目适配器边界。
